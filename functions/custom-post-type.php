...
function custom_post_artist() { 
	...
	register_post_type( 'artist', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			'name' => __('Artist Profiles', 'jointswp'), /* This is the Title of the Group */
			'singular_name' => __('Artist Profiles', 'jointswp'), /* This is the individual type */
			'all_items' => __('All Artist Profiles', 'jointswp'), /* the all items menu item */
			'add_new' => __('Add New', 'jointswp'), /* The add new menu item */
			'add_new_item' => __('Add New Artist Profile', 'jointswp'), /* Add New Display Title */
			'edit' => __( 'Edit Artist Profiles', 'jointswp' ), /* Edit Dialog */
			'edit_item' => __('Edit Artist Profiles', 'jointswp'), /* Edit Display Title */
			'new_item' => __('New Artist Profile', 'jointswp'), /* New Display Title */
			'view_item' => __('View Artist Profile', 'jointswp'), /* View Display Title */
			'search_items' => __('Search Artist Profiles', 'jointswp'), /* Search Custom Type Title */ 
			'not_found' =>  __('Nothing found in the Database.', 'jointswp'), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __('Nothing found in Trash', 'jointswp'), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is the Artist Profile custom post type', 'jointswp' ), /* Custom Type Description */
			'public' => true,
